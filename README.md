...
| d. Use-Case Diagram | [`usecase/SIM_UseCase_Diagram.svg`](usecase/SIM_UseCase_Diagram.png) | Shows how Students/Villa-mates, Staff, Landlords, and Security Admin interact with the system. |
